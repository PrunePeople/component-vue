<template>
  <!-- Le contenu de ce composant est défini dans le template -->
  ...
  <div>
    ...
    <div>
      ...
      <div>
        <!-- Use the correct component name with capitalization -->
        <Button title="Enregistrer" color="blue"/>
        <Button title="Modifier" color="red"/>
        <Button :title="count" :color="colorParent[2]"/>
        <Button title="Connexion" :color="colorParent[3]"/>
...
export default {
  ...
  data() {
    return {
      count: 100,
      colorParent : ['blue', 'red', 'yellow', 'green'],
      users: [
  {
    id: 1,
    firstName: "Terry",
...
h1 {
  ...
  padding: 40px;
  border: 5px solid rgb(94, 94, 101);
}
